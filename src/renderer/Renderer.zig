...
cached_viewport_offset: usize,
last_cursor_node: ?*anyopaque,
last_cursor_pin_y: usize,
last_cursor_x: usize,
last_cursor_y: usize,
last_cursor_visible: bool,
last_cursor_blinking: bool,
...
pub fn init(surface: *Surface) Renderer {
    return Renderer{
        ...
        .last_viewport_y = 0,
        .cached_viewport_offset = 0,
        .last_cursor_node = null,
        .last_cursor_pin_y = 0,
        .last_cursor_x = 0,
        .last_cursor_y = 0,
        .last_cursor_visible = true,
        .last_cursor_blinking = false,
        .last_cursor_style = .block,
        .last_cols = 0,
        .last_rows = 0,
        ...
        .cached_cursor_in_viewport = true,
